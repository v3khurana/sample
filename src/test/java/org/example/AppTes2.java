...
public class AppTes2
{
    ...
    public void job6() throws Exception {
        ...
        String jobID = "AMFAM MSP-JB-689";
        String jobManager = "Kirthika Muthukumaran";
        String hiringManager = "John Paquette";
        ...
        lg.login("https://preprod-app.simplifyvms.com/","simplifyqa+paquette@simplifyvms.com","Demo@1234");
        Sidebar.navigate("Job","View All Job");
        JobList.searchByJobTitleOrJobId(jobID);
        JobList.navigateToJobDetails();
        JobDetails.navigateTabs("Approval");
        //JobDetails.approveJob("Hiring Manager", hiringManager);
        JobDetails.approveJob("Client Administrator", hiringManager);
